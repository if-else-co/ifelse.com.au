...
const Checkmark = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
    <path class="pricing__checkmark" d="M12 22a10 10 0 1 1 0-20 10 10 0 0 1 0 20zm0-2a8 8 0 1 0 0-16 8 8 0 0 0 0 16zm-2.3-8.7l1.3 1.29 3.3-3.3a1 1 0 0 1 1.4 1.42l-4 4a1 1 0 0 1-1.4 0l-2-2a1 1 0 0 1 1.4-1.42z"/>
  </svg>
);
  ...
  return (
    <div className="pricing">
      <div className="pricing__grid">
          ...
          <div className="pricing__plan pricing--blue">
            ...
            <div>
              <div className="pricing__plan-contents-section">
                <div className="pricing__plan-contents-item"><Checkmark /></div>
                <div className="pricing__plan-contents-item"><Checkmark /></div>
        ...
        <div className="pricing__grid-item">
          <div className="pricing__plan pricing--yellow">
            <div className="pricing__overview">
        ...
        <div className="pricing__grid-item">
          <div className="pricing__plan pricing--purple">
            ...
            <div>
              <div className="pricing__plan-contents-section">
                <div className="pricing__plan-contents-item">
                  <Checkmark />
                </div>
                <div className="pricing__plan-contents-item">
                  <Checkmark />
